				   ...
				   <thead>
				    ...
				    ?>
					 <tr>
					   ...
					   <td><span class="label label-{{$statusClass}}">{{strtoupper($pd['in_stock'])}}</span></td>
					   <td>
					     <a class="btn btn-info" href="{{$uu}}">Add to cart</span></a>
					     <a class="btn btn-danger" href="{{$du}}"><span class="ion-android-delete"></span></a>
					   </td>
					 </tr>
					<?php
						 }  
