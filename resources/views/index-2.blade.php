                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 product-item-container effect-wrap effect-animate">
                          <div class="product-main">
                            <div class="product-view">
                              <figure class="double-img"><a href="{{$uu}}"><img class="btm-img " src="{{$imggs[1]}}" data-src="{{$imggs[1]}}" width="215" height="240"  alt=""/> <img class="top-img " src="{{$imggs[0]}}" data-src="{{$imggs[0]}}" width="215" height="240"  alt=""/></a></figure>
                            </div>
              ...
              <div>
                <div class="row">
                  <div class="col-sm-6 col-md-4">
                    <figure><img class="img-responsive " src="{{$imggs[0]}}" data-src="{{$imggs[0]}}" width="200" height="230" alt=""/></figure>
                  </div>
