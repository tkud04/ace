...
Hello {{$u['name']}},<br> You just placed an order on our website. See the details below:<br><br>
...
<p>Click the button below to confirm your payment for this order. Alternatively you can load your order online to confirm payment for this order (go to Orders, enter the reference number and click the Verify Payment button beside the order).</p><br>
