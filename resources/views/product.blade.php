                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 sub-info">
					 ...
					 <input type="hidden" id="cu" value="{{$cu}}">
                      ...
                      <div class="product-price clearfix"> <span class="pull-left btn btn-primary"><strong>&#8358;{{number_format($amount, 2)}}</strong></span> <span class="pull-left btn btn-link"><del>&#8358;{{number_format($amount + 1000, 2)}}</del></span> </div>
                      ...
                      <div class="product-quantity">
                        ...
                        <a href="javascript:void(0)"  onclick="addToCart({sku:'{{$sku}}',qty:'1'})" class="btn btn-primary pull-left hvr-underline-from-center-primary">Add To Cart</a> </div>
                    </div>
                  </div>
                  <hr>
                </div>
