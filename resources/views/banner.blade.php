<!--start of banner-->
  ...
  ?>
	...
	<img class="img-responsive hidden-xs" src="{{$img}}" style="height: 400px; object-fit: contain;" width="750"  alt=""/>
    <img class="img-responsive visible-xs" src="{{$img}}" style="height: 400px; object-fit: contain;" width="750" alt=""/>
