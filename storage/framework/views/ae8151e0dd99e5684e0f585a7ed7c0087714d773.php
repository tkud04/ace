      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="row">
			...
			<div class="col-sm-12">
			      <form role="form" action="<?php echo e(url('review-order')); ?>" method="post" enctype="multi-part/formdata">
					  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\ace\resources\views/review-order.blade.php ENDPATH**/ ?>