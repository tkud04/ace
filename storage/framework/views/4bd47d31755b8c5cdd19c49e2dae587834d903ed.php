                    ...
                    <div class="col-sm-6 sub-info">
					 ...
					 <input type="hidden" id="cu" value="<?php echo e($cu); ?>">
                      ...
                      <div class="product-quantity">
                        ...
                        <a href="javascript:void(0)" onclick="addToCart({sku:'<?php echo e($sku); ?>',qty:'1',amount:'<?php echo e($amount); ?>'})" id="add-to-cart-btn" class="btn btn-primary pull-left hvr-underline-from-center-primary">Add To Cart</a> </div>
                    </div>
                  </div>
                  <hr>
                </div>
